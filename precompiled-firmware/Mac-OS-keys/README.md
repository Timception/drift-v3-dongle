...
> 
> If you are still unsure, you can have a look at the [pdf file](https://github.com/Timception/drift-v3-dongle/blob/main/precompiled-firmware/Mac-OS-keys/Setup-Drift-on-Macbook.pdf) listed above.
